...
import { DemandeatraiteranacService } from '../../service/demandeatraiteranac.service';
...
export class MainContentComponent implements OnInit, AfterViewInit {
	...
	constructor(private demandeatraiteranacService: DemandeatraiteranacService,
	...
	ngOnInit() {
		this.listedesdemandeatraiteranac();
	...
	listedesdemandeatraiteranac() {
		this.paiement$ = this.demandeatraiteranacService.getDemandeATraiterANAC()
			.pipe(
			  map((data: any) => {
		...
		/*this.demandeatraiteranacService.getDemandeATraiterANAC().subscribe(
			(data: any) => {
				this.dataSource = new MatTableDataSource<any>(data.data);
				this.dataSource.paginator = this.paginator;
				this.dataSource.sort = this.sort;
	...
	openDialogTraitementAnac(data): void {
