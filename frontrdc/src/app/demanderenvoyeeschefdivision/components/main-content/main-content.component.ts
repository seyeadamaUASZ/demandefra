...
import { DemanderenvoyeeschefdivisionService } from '../../service/demanderenvoyeeschefdivision.service';
...
export class MainContentComponent implements OnInit, AfterViewInit {
	...
	constructor(private demanderenvoyeeschefdivisionService: DemanderenvoyeeschefdivisionService,
	...
	listDemandeRenvoyees() {
		this.renvoie$ = this.demanderenvoyeeschefdivisionService.getDemandeRenvoyees()
		.pipe(
		  map((data: any) => {
