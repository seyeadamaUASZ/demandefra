...
import { DemandeacorrigerService } from '../../service/demandeacorriger.service';
...
export class MainContentComponent implements OnInit, AfterViewInit {
	...
	constructor(private demandeacorrigerService: DemandeacorrigerService,
	...
	listeDemandesAcorriger() {
		this.paiement$ = this.demandeacorrigerService.getDemandeACorriger(this.owner)
			.pipe(
			  map((data: any) => {
		...
		/*this.demandeacorrigerService.getDemandeACorriger(this.owner).subscribe(
			(data: any) => {
				this.dataSource = new MatTableDataSource<any>(data.data);
				this.dataSource.paginator = this.paginator;
				this.dataSource.sort = this.sort;
