...
import { DemandetraiteranacService } from '../../service/demandetraiteranac.service';
...
export class MainContentComponent implements OnInit, AfterViewInit {
	...
	constructor(private demandetraiteranacService: DemandetraiteranacService,
	...
	ngOnInit() {
		this.listedesdemandetraiteranac();
	...
	listedesdemandetraiteranac() {
		this.paiement$ = this.demandetraiteranacService.getDemandeTraiterANAC()
			.pipe(
			  map((data: any) => {
		...
		/*this.demandetraiteranacService.getDemandeTraiterANAC().subscribe(
			(data: any) => {
				this.dataSource = new MatTableDataSource<any>(data.data);
				this.dataSource.paginator = this.paginator;
				this.dataSource.sort = this.sort;
