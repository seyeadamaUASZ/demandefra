package sn.gainde2000.pi.core.generate;
...
public class ProduitIdGenerator implements IdentifierGenerator {
    @Override
    public Serializable generate(SharedSessionContractImplementor sharedSessionContractImplementor, Object o) throws HibernateException {
        ...
        try {
            ...
            ResultSet rs = statement.executeQuery("SELECT count(numero_id) FROM numero_produit");
            int id = 0;
            if (rs.next()) {
                id = rs.getInt(1);
            }
            String prefix = generateString(id);
            return prefix + suffix+ "/FRA";
